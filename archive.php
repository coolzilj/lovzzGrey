...
<div id="main">
	...
	<?php if (is_category()){?>
    	<h2 class="wizard">你正在浏览 <span class="category"><?php single_cat_title(); ?></span> 分类下的文章</h2>
        <?php }elseif (is_month()){?>
        <h2 class="wizard">你正在浏览 <?php the_time('F,Y'); ?> 分类下的文章</h2>
        <?php }elseif(is_year()){?>
        <h2 class="wizard">你正在浏览 <?php the_time('Y'); ?> 分类下的文章</h2>
        <?php }?>
